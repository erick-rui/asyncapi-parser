...
/**
 *
 * @see "https://github.com/asyncapi/asyncapi/blob/master/versions/2.0.0/asyncapi.md#messageBindingsObject"
 *
 */
...
public class MessageBinding {
    ...
    */
    ...
    public boolean equals(final Object obj) {
        ...
        final MessageBinding other = (MessageBinding) obj;
    ...
    @Override
    public String toString() {
        return "MessageBindings [extensions=" + this.extensions + "]";
    }
