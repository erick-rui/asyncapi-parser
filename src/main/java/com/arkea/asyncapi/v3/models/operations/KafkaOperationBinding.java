...
/**
 *
 * @see "https://github.com/asyncapi/bindings/blob/master/kafka/README.md#operation"
 *
 */
public class KafkaOperationBinding extends OperationBinding {
    ...
    public boolean equals(final Object obj) {
        ...
        final KafkaOperationBinding other = (KafkaOperationBinding) obj;
    ...
    public String toString() {
        return "KafkaOperationBinding [groupId=" + this.groupId + ", clientId=" + this.clientId + ", bindingVersion=" + this.bindingVersion + "]";
    }
